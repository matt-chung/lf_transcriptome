---
title: "A. aegypti transcriptome v2"
...
```{r setinputs}
counts.path <- "X:/mattchung/aaegypti_counts.tsv"
tpm.path <- "X:/mattchung/EBMAL/aaegypti_tpm.tsv"
groups.path <- "X:/mattchung/EBMAL/aaegypti_groups.tsv"
geneinfo.path <- "X:/mattchung/EBMAL/aaegypti_gene.info"
output_dir <- "Z:/EBMAL/mchung_dir/aaegypti_transcriptome"
```
...
pca.plot <- ggplot()+
  geom_point(aes(x=pca$ind$coord[,1], y=pca$ind$coord[,2], color = groups[,2], size = colSums(counts)))+
